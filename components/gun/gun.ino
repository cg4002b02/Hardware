...
void loop(){
  ...
  if (protoState == CONFIRMED && !hasSentGun) {
      // sendgun();
      // if (ammo > 0){
      //   ammo -= 1;
      // } else {
...
void senddata(imuData_t imuData){
  ...
  if (protoState == CONFIRMED && imuWindowIndex < IMU_WINDOW_SIZE) {
...
// void sendImuData(imuData_t imuData, bool isMotion)
// {
...
//     if (imuWindowIndex == IMU_WINDOW_SIZE)
//     {
//       if (isMotionCounter > IMU_WINDOW_SIZE / 2) {
//         // send imuDataArray
//         Serial.println("imuDataArray is full, sending data...");
//       } else {
//         Serial.println("False motion");
//       }
//     }
//   }
//   else
